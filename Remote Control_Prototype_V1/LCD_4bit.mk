SHELL=cmd
OBJS=main.o usart.o lcd.o pushbutton.o SoftwareUart.o
...
pushbutton.o: pushbutton.c pushbutton.h usart.h
	avr-gcc -g -Os -Wall -mmcu=atmega328p -c pushbutton.c
	
SoftwareUart.o: SoftwareUart.c SoftwareUart.h usart.h
